...
export default function Software() {
  ...
  return (
    ...
    >
      ...
      <div
        className="w-full max-w-md mx-auto flex flex-col gap-6 mt-0 items-center justify-center"
      ...
      >
        <div className="flex flex-col items-center">
          ...
          <p className="text-sm text-neutral-600 dark:text-white text-center">
            Portfolio optimization with statistical physics.
          </p>
          <em className="text-sm text-neutral-500 dark:text-white text-center">
