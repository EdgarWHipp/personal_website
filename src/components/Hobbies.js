...
export default function Hobbies() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white py-12 relative items-center justify-center">
      ...
      <div className="w-full max-w-xl mx-auto flex flex-col items-center gap-8">
        {/* Fixed slider area */}
        <div className="flex flex-col items-center justify-center w-full" style={{ height: '520px', minHeight: '520px' }}>
          <div className="flex flex-row items-center justify-center gap-4 w-full" style={{ height: '320px', minHeight: '320px' }}>
            {/* Left button */}
            <button
              onClick={goLeft}
            ...
            {/* Image */}
            <div className="flex flex-col items-center justify-center" style={{ minWidth: '320px', maxWidth: '480px', height: '260px', justifyContent: 'center' }}>
          ...
          <div className="flex flex-col items-center justify-start px-4" style={{ height: '64px', marginTop: '48px' }}>
            <div className="text-xs md:text-sm font-normal text-neutral-700 whitespace-pre-line text-center leading-relaxed flex items-center justify-center w-full" style={{ fontFamily: 'inherit', height: '64px' }}>
              {infoTexts[current]}
            </div>
          </div>
        </div>
