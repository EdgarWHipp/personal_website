    ...
    <>
      ...
      >
        ...
        >
          {/* Mail */}
          <a
            href="mailto:edgarhipp@protonmail.com"
            title="Email"
            style={{
              display: "flex", alignItems: "center", justifyContent: "center",
              width: 32, height: 32,
              borderRadius: "8px",
              background: "rgba(80,75,70,0.12)",
              backdropFilter: "blur(8px)",
              WebkitBackdropFilter: "blur(8px)",
              color: "rgba(90,87,83,0.9)",
              border: "1px solid rgba(100,95,90,0.18)",
              boxShadow: "0 1px 3px rgba(0,0,0,0.12)",
              transition: "transform 0.18s ease, background 0.18s ease",
              textDecoration: "none",
            }}
            onMouseEnter={e => { e.currentTarget.style.transform = "scale(1.12)"; e.currentTarget.style.background = "rgba(80,75,70,0.22)"; }}
            onMouseLeave={e => { e.currentTarget.style.transform = "scale(1)"; e.currentTarget.style.background = "rgba(80,75,70,0.12)"; }}
          >
          ...
          <span style={{ color: "rgba(180,178,174,0.35)", fontSize: 13, userSelect: "none" }}>·</span>

          {/* CV */}
          <a
            href="/Resume__one.Resume___one_page-14.pdf"
            download
            title="Download CV"
            style={{
              display: "flex", alignItems: "center", justifyContent: "center",
          ...
          >
            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.741l7.73-8.835L2.25 2.25h6.893l4.255 5.623zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
            </svg>
          </a>
          ...
          {/* GitHub */}
          <a
            href="https://github.com/EdgarWHipp"
            target="_blank"
            rel="noreferrer"
            title="GitHub"
            style={{
        ...
        >
          <div className="w-full max-w-xl mx-auto flex flex-row justify-between items-end px-4 text-xs text-neutral-500">
            <div className="text-left leading-tight">
              ...
              <span className="card-line-3">Software Engineer</span><br />
